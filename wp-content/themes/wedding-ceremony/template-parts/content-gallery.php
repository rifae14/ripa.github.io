...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="mag-post-single">
        <?php
		    ...
		    $wedding_ceremony_post_id = get_the_ID(); // Add this line to get the post ID
		    $wedding_ceremony__gallery_shortcode = get_post_gallery();

		    if (!empty($wedding_ceremony__gallery_shortcode)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($wedding_ceremony__gallery_shortcode) . '</div>';
		    }
		?>
